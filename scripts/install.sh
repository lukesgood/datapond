...
echo -e "    JupyterLab  →  http://${DOMAIN}/jupyter  (token: kubectl -n datapond get secret datapond-secrets -o jsonpath='{.data.JUPYTER_TOKEN}' | base64 -d   — quicktest profile: 'jupyter')"
