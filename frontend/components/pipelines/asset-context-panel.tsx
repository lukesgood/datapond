  ...
  return (
    <div className="w-80 h-full border-l bg-background flex flex-col overflow-hidden shrink-0 animate-in slide-in-from-right-4 duration-200">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5">
        {/* Properties */}
        <section>
          <h4 className="text-2xs uppercase tracking-widest text-muted-foreground mb-2">Properties</h4>
        ...
        {upstream.length > 0 && (
          <section>
            <h4 className="text-2xs uppercase tracking-widest text-muted-foreground mb-2 flex items-center gap-1">
        ...
        {/* Quick actions */}
        <section>
          <h4 className="text-2xs uppercase tracking-widest text-muted-foreground mb-2">Actions</h4>
          <div className="space-y-1.5">
            <a
