...
// The Dashboards half of the Analytics workspace — saved SQL queries rendered as
// live charts. It re-runs each dashboard's query through the same /queries/execute
// path the SQL Editor uses, so the two tabs share one engine and gate.
    ...
    <div className="flex flex-col" style={{ minHeight: "calc(100vh - 56px)" }}>
      ...
      <div className="flex items-center gap-1.5 border-b px-3 h-11 shrink-0 bg-background">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button size="sm" className="h-8 text-xs gap-1.5" onClick={() => router.push("/query")}>
      ...
      <div className="flex-1 space-y-5 px-6 py-5">
        <p className="text-sm text-muted-foreground">Saved SQL queries visualised as charts</p>
            ...
            <CardContent className="py-16 text-center space-y-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Run a query in the SQL Editor and click &quot;Save as Dashboard&quot;
                </p>
              </div>
