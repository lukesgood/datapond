...
// The Documentation half of the Help workspace — the concept/profile/operations
// index. Rendered in the ?tab=docs panel; article deep links (/docs/[slug]) are
// preserved and reached from the cards below.
