...
from app.component_guard import capability_on, require_capability, require_component
...
# Tests for require_component (feature-flag gating for individual components)
