...
DataPond는 이 조직들이 **자체 인프라 위에서** Databricks 수준의 AI 데이터 플랫폼을 운영할 수 있게 합니다.
...
| **PostgreSQL** | 공유 메타데이터 DB | 내부 (port 5432) |
| **Valkey** | Redis 호환 캐시 | 내부 (port 6379) |
...
| [CLAUDE.md](CLAUDE.md) | AI 에이전트 협업 가이드 (개발자용) |
